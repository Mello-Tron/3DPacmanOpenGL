...
class Wall : public graphics_object
{
public:
	Wall() : graphics_object("SkyCube") {}
	...
	{	 // For this texture map, the normal are set to
		...
		normal.push_back(normalize(vec4to3(wall_vertices[a])));
		vertex.push_back(wall_vertices[a]);

		normal.push_back(normalize(vec4to3(wall_vertices[b])));
		vertex.push_back(wall_vertices[b]);

		normal.push_back(normalize(vec4to3(wall_vertices[c])));
		vertex.push_back(wall_vertices[c]);
	}
